...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.setGraphicSize(Std.int(logoBl.width * 0.9), Std.int(logoBl.height * 0.9));
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('teamDrift'));
		add(ngSpr);
		ngSpr.visible = false;
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					...
					createCoolText(['That one good', 'Spider-man mod']);
				...
				case 14:
					addMoreText("Vs Spider-man", 15);

				case 15:
					addMoreText("Volume III", 15);
