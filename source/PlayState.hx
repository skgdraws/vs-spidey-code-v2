...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case "road":
				var sky:BGSprite = new BGSprite("octo/sky", -450, -350, 0.7, 0.7);
				add(sky);

				var bg:BGSprite = new BGSprite("octo/octo-background", -450, -350, 0.75, 0.75);
				add(bg);

				var foreground:BGSprite = new BGSprite("octo/octo-foreground", -450, -350, 0.9, 0.9);
				add(foreground);

			case "electro":
				var sky:BGSprite = new BGSprite("electro/sky", -550, -300, 0.7, 0.7);
				add(sky);
				
				electroBG = new BGSprite("electro/bg", -550, -300, 0.8, 0.8, ["shine", "bg shine"]);
				add(electroBG);

				var ground:BGSprite = new BGSprite("electro/ground", -550, -300, 0.9, 0.9);
				add(ground);
			...
			case "liberty":
				...
				var liberty:BGSprite = new BGSprite("goobler/liberty", -600, -500, 0.8, 0.9);
				add(liberty);

				var floor:BGSprite = new BGSprite("goobler/floor", -600, -500, 0.9, 0.9);
				add(floor);

				var shield:BGSprite = new BGSprite("goobler/shield", -600, -500, 1.1, 1.1);
				add(shield);
		}
		...
		switch(SONG.player2){
			...
			case 'spiderman' | 'spidey-hybrid' | 'spidey-magic':
				...
				switch (swagCounter)
				{
					case 0:
						if(introSoundsSuffix == "-pixel"){
							...
							FlxG.sound.play(Paths.sound('intro3' + introSoundsSuffix, "pics-of-spidey"), 0.6);
						}
					...
					case 1:
						...
						if(introSoundsSuffix == "-pixel"){
							...
							FlxG.sound.play(Paths.sound('intro2' + introSoundsSuffix, "pics-of-spidey"), 0.6);
						}
					...
					case 2:
						...
						if(introSoundsSuffix == "-pixel"){
							...
							FlxG.sound.play(Paths.sound('intro1' + introSoundsSuffix, "pics-of-spidey"), 0.6);
						}
					...
					case 3:
						...
						if(introSoundsSuffix == "-pixel"){
							...
							FlxG.sound.play(Paths.sound('introGo' + introSoundsSuffix, "pics-of-spidey"), 0.6);
						}
					case 4:
				}
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['week1_beat', 'week2_beat', 'week3_beat', 'week4_beat',
				'week5_beat', 'week6_beat', 'week7_beat', 'ur_bad',
	...
	function lightningShine():Void
	{
		electroBG.animation.play('bg shine');
	}
	...
	override function beatHit()
	{
		...
		if (curStage == 'electro' && FlxG.random.bool(10) && curBeat > lightningStrikeBeat + lightningOffset)
		{
			lightningShine();
		}
		lastBeatHit = curBeat;
	...
	private function checkForAchievement(achievesToCheck:Array<String>):String {
		...
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				{
					case 'week1_beat' | 'week2_beat' | 'week3_beat' | 'week4_beat' | 'week5_beat' | 'week6_beat' | 'week7_beat':
						if(isStoryMode && storyPlaylist.length <= 1 && !changedDifficulty && !usedPractice)
						{
							...
							switch(weekName) //I know this is a lot of duplicated code, but it's easier readable and you can add weeks with different names than the achievement tag
							{
								...
								case 'week7':
									if(achievementName == 'week7_beat') unlock = true;
							}
						}
					case 'ur_bad':
