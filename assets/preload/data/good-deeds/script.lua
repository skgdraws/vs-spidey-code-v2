...
function onCreate()
	...
	makeAnimatedLuaSprite('Dad2', 'characters/spidey-mirror-gb', defaultBoyfriendX + 250, defaultBoyfriendY + 50); -- Change to characters idle in XML
	addAnimationByPrefix('Dad2', 'idle', 'spidey-mirror-gb Idle Dance', 24, false); -- Change to characters idle in XML
    addAnimationByPrefix('Dad2', '0', 'spidey-mirror-gb Sing Note LEFT', 24, false); -- Change to characters leftnote in XML
    addAnimationByPrefix('Dad2', '1', 'spidey-mirror-gb Sing Note DOWN', 24, false); -- Change to characters downnote in XML
    addAnimationByPrefix('Dad2', '2', 'spidey-mirror-gb Sing Note UP', 24, false); -- Change to characters upnote in XML
    addAnimationByPrefix('Dad2', '3', 'spidey-mirror-gb Sing Note RIGHT', 24, false); -- Change to characters rightnote in XML
